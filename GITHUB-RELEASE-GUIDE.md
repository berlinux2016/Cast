...
```
gnome-cast-player-2.0.0.tar.gz      (84 KB)  - Gzip compressed
gnome-cast-player-2.0.0.tar.bz2     (68 KB)  - Bzip2 compressed (smaller)
gnome-cast-player-2.0.0.sha256      (207 B)  - SHA256 checksums
```
...
1. Go to: https://github.com/berlinux2016/gnome-cast-player
...
- **Tag version:** `v2.0.0`
- **Target:** `main` branch
- **Release title:** `GNOME Cast Player v2.0.0`
...
- **Fixed Play/Pause button crashes** when switching between Cast device and local playback
- **Eliminated memory leaks** from signal handlers
- **Improved Cast device streaming** workflow and reliability

### 📦 Installation

**Fedora/RHEL (Recommended):**
```bash
tar -xzf gnome-cast-player-2.0.0.tar.gz
cd gnome-cast-player-2.0.0
./build-rpm.sh
...
See [INSTALL.md](https://github.com/berlinux2016/gnome-cast-player/blob/main/INSTALL.md) for detailed instructions.

### 🔍 Checksums

**SHA256:**
```
3658a9eed3d2ecf79953f2b543149a0612ebca581e233e3c5d5eec2fe7a1a007  gnome-cast-player-2.0.0.tar.bz2
0971be7b3d16d790a6b38001a2ec35f2321776b3aee9b89ccd06cf08fa65c2b2  gnome-cast-player-2.0.0.tar.gz
```

**Full Changelog:** https://github.com/berlinux2016/gnome-cast-player/compare/v1.3.0...v2.0.0
```
...
1. ✅ `gnome-cast-player-2.0.0.tar.gz`
2. ✅ `gnome-cast-player-2.0.0.tar.bz2`
3. ✅ `gnome-cast-player-2.0.0.sha256`
...
Visit: https://github.com/berlinux2016/gnome-cast-player/releases/tag/v2.0.0
...
```bash
wget https://github.com/berlinux2016/gnome-cast-player/releases/download/v2.0.0/gnome-cast-player-2.0.0.tar.gz
sha256sum gnome-cast-player-2.0.0.tar.gz
...
```markdown
[![Release](https://img.shields.io/github/v/release/berlinux2016/gnome-cast-player)](https://github.com/berlinux2016/gnome-cast-player/releases/latest)
```
...
```
gnome-cast-player-2.0.0/
├── videoplayer.py              # Main application (172 KB)
├── README.md                   # Full documentation
├── LICENSE                     # MIT License
├── gnome-cast-player.spec
├── gnome-cast-player.desktop
├── gnome-cast-player.appdata.xml
├── gnome-cast-player.svg
...
```bash
sha256sum -c gnome-cast-player-2.0.0.sha256
```
...
```bash
gpg --detach-sign --armor gnome-cast-player-2.0.0.tar.gz
```
...
1. Go to: https://github.com/berlinux2016/gnome-cast-player/releases
