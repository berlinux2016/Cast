...
- Persistent storage in `~/.config/video-cast-player/recent_files.json`
...
- **Fixed crash** when switching between Cast device and local playback
...
### Cast device Streaming Improvements
...
### Streaming
- pychromecast (for Cast device support)
...
- ✅ **Cast device Streaming** with automatic format conversion
...
- **Homepage:** https://github.com/berlinux2016/gnome-cast-player
- **Issues:** https://github.com/berlinux2016/gnome-cast-player/issues
- **Releases:** https://github.com/berlinux2016/gnome-cast-player/releases
...
- Improved Cast device streaming workflow
...
If you encounter any issues, please report them on our [issue tracker](https://github.com/berlinux2016/gnome-cast-player/issues).
