#!/bin/bash
# Installations-Skript für Video Cast Player mit AMD Hardware-Beschleunigung

echo "=== Video Cast Player Installation (AMD-optimiert) ==="
echo ""
...
echo "  ./videoplayer.py"
echo ""
echo "Oder suche nach 'Video Cast Player' in deinen Anwendungen."
echo ""
echo "Hinweise:"
