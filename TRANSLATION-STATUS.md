...
#### German (de)
- `locale/de/LC_MESSAGES/gnome-cast-player.po` (18K)
- `locale/de/LC_MESSAGES/gnome-cast-player.mo` (17K compiled)
- **Status**: ✅ Complete with 200+ translated strings

#### English (en)
- `locale/en/LC_MESSAGES/gnome-cast-player.po` (12K)
- `locale/en/LC_MESSAGES/gnome-cast-player.mo` (1.2K compiled)
...
| Tooltips | 40+ | "Vollbild (F11)", "Cast Geräte suchen" |
...
| Cast device messages | 40+ | "Gerät gefunden", "Warte auf Antwort" |
...
from i18n import _
self.set_title(_("Video Cast Player"))
...
msginit --input=locale/messages.pot \
        --locale=fr_FR \
        --output=locale/fr/LC_MESSAGES/gnome-cast-player.po

# 3. Translate strings in .po file
# (Use Poedit or any text editor)

# 4. Compile translation
msgfmt locale/fr/LC_MESSAGES/gnome-cast-player.po \
       -o locale/fr/LC_MESSAGES/gnome-cast-player.mo
...
│   ├── de/LC_MESSAGES/
│   │   ├── gnome-cast-player.po   # German source
│   │   └── gnome-cast-player.mo   # German compiled
│   └── en/LC_MESSAGES/
│       ├── gnome-cast-player.po   # English source
│       └── gnome-cast-player.mo   # English compiled
│
...
# Should show:
# locale/de/LC_MESSAGES/gnome-cast-player.mo (17K)
# locale/en/LC_MESSAGES/gnome-cast-player.mo (1.2K)
```
...
1. Copy `locale/en/LC_MESSAGES/gnome-cast-player.po`
