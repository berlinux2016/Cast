...
This guide explains how to use and maintain translations for the Video Cast Player.
...
├── de/
│   └── LC_MESSAGES/
│       ├── gnome-cast-player.po   # German translation source
│       └── gnome-cast-player.mo   # Compiled German translation
└── en/
    └── LC_MESSAGES/
        ├── gnome-cast-player.po   # English translation source
        └── gnome-cast-player.mo   # Compiled English translation
```
...
2. Update existing translations:
   ```bash
   # Update German
   msgmerge --update locale/de/LC_MESSAGES/gnome-cast-player.po locale/messages.pot

   # Update English
   msgmerge --update locale/en/LC_MESSAGES/gnome-cast-player.po locale/messages.pot
   ```
...
4. Compile translations:
   ```bash
   # German
   msgfmt locale/de/LC_MESSAGES/gnome-cast-player.po -o locale/de/LC_MESSAGES/gnome-cast-player.mo

   # English
   msgfmt locale/en/LC_MESSAGES/gnome-cast-player.po -o locale/en/LC_MESSAGES/gnome-cast-player.mo
   ```
...
2. Initialize translation from template:
   ```bash
   msginit --input=locale/messages.pot --locale=[LANG] --output=locale/[LANG]/LC_MESSAGES/gnome-cast-player.po
   ```
...
4. Compile the translation:
   ```bash
   msgfmt locale/[LANG]/LC_MESSAGES/gnome-cast-player.po -o locale/[LANG]/LC_MESSAGES/gnome-cast-player.mo
   ```
...
2. **Provide context**:
   ...
   window.set_title(_("Video Cast Player"))
   ```
...
2. Verify locale directory exists:
   ```bash
   file locale/de/LC_MESSAGES/gnome-cast-player.mo
   ```
...
- Open an issue: https://github.com/berlinux2016/gnome-cast-player/issues
