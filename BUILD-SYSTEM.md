...
├── RPMS/
│   └── noarch/
│       └── gnome-cast-player-2.0.0-1.*.rpm  # Binary RPM
├── SOURCES/
│   └── gnome-cast-player-2.0.0.tar.gz       # Source tarball
├── SPECS/
│   └── gnome-cast-player.spec               # Spec file
└── SRPMS/
    └── gnome-cast-player-2.0.0-1.*.src.rpm  # Source RPM
```
