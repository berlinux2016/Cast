# AUR Submission Guide for gnome-cast-player
...
```bash
git clone ssh://aur@aur.archlinux.org/gnome-cast-player.git aur-gnome-cast-player
cd aur-gnome-cast-player
```
...
git commit -m "Initial commit: gnome-cast-player 2.0.0"
...
```bash
# Initial submission
git clone ssh://aur@aur.archlinux.org/gnome-cast-player.git
