#!/bin/bash
# Installation script for Video Cast Player on Arch Linux
# Installationsskript für Video Cast Player auf Arch Linux

echo "=== Video Cast Player Installation (Arch Linux) ==="
echo ""
...
mkdir -p "$ICON_DIR"
if [ -f "icon.svg" ]; then
    cp icon.svg "$ICON_DIR/video-cast-player.svg"
elif [ -f "gnome-cast-player.svg" ]; then
    cp gnome-cast-player.svg "$ICON_DIR/video-cast-player.svg"
fi

# Create desktop entry
echo "Creating desktop shortcut..."
DESKTOP_FILE="$HOME/.local/share/applications/video-cast-player.desktop"
...
echo "  ./videoplayer.py"
echo ""
echo "Or search for 'Video Cast Player' in your applications."
echo ""
echo "Notes:"
