...
- **MKV/AVI zu MP4**: Der Player konvertiert automatisch inkompatible Video-Formate zu MP4 beim Cast Streaming
- **Intelligentes Caching**: Konvertierte Videos werden in `~/.cache/video-cast-player/` gespeichert
...
- Detaillierte Logging-Ausgaben für alle Cast Operationen
...
- `debug-chromecast.sh`: Umfassendes Diagnose-Tool für Cast Probleme
...
### Behobene Probleme
- ✓ Cast Discovery-Timeout erhöht (15 Sekunden)
- ✓ Verbesserte Fehlerbehandlung bei HTTP-Server-Start
- ✓ Standby-Inhibitor während Streaming
- ✓ Bessere Unterstützung für verschiedene Cast Modelle
